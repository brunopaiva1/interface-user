...
layout = [
    ...
    [sg.Text('Senha'), sg.Input(key='senha', password_char='*', size=(20,1))], #layout definido para senha
...
while True:
    ...
    if eventos == sg.WINDOW_CLOSED: #fechando janela
        break
    if eventos == 'Login':
        if valores['usuario'] == 'brunopaiva' and valores['senha'] == 'python3': #se o usuario for o solicitado ira imprimir o testo ta linha a seguir
